...
public sealed class CancelExternalCallHandler : Interfaces.IMessageHandler<Messages.CancelExternalCallMessage>
{
    ...
    {
        Handle((Messages.CancelExternalCallMessage)msg, elevatorManager);
    }

    /// <inheritdoc />
    public void Handle(Messages.CancelExternalCallMessage msg, Interfaces.IElevatorManager elevatorManager)
    {
        elevatorManager.CancelFloorCall(msg.Floor, msg.Direction);
    }
}
